 ...
 * cnberry and liadgr
 *
 * Contains implementations of functions in the graphics class which respresent a 100 x 100 image.
 */
...
// create the default constructor - all pixels set to black
Graphics::Graphics(){
    Color();
}
...
// set the pixel at the given coordinate to the color passed
