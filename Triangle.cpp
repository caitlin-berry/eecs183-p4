 ...
 * cnberry and liadgr
 *
 * Contains implementations of functions in the triangle class which represent a triangle.
 */
...
Triangle::Triangle(Point pt1, Point pt2, Point pt3, Color color){
    // set all verticies to their own point but same color
    vertexOne = pt1;
    vertexTwo = pt2;
    vertexThree = pt3;
...
Triangle::Triangle(Point pt1, Color color1, Point pt2, Color color2,
    ...
    // set all verticies to their own point and own color
    vertexOne = pt1;
    vertexTwo = pt2;
    vertexThree = pt3;
...
void Triangle::setColor(Color color){
    // set all verticies to the same color
    vertexOneColor = color;
    vertexTwoColor = color;
    vertexThreeColor = color;
}
